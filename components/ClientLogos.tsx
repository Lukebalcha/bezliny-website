...
const clients = [
  "SIEMENS", "VESTAS", "ØRSTED", "EQUINOR", "MAERSK",
  "STRABAG", "SKANSKA", "BOUYGUES", "VINCI", "ACCIONA",
  "SHELL", "TOTAL", "VATTENFALL", "RWE", "ENGIE",
];
  ...
  return (
    <section className="py-10 md:py-14 border-b border-white/[0.03] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 mb-6">
        <span className="text-[10px] uppercase tracking-[0.3em] text-white/30">Trusted by Industry Leaders</span>
      </div>
