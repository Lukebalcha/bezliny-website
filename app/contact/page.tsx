    ...
    <>
      <section className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <FadeUp>
            <span className="text-xs uppercase tracking-[0.3em] text-[#34C7FF]">Get In Touch</span>
              ...
              <div className="space-y-8">
                ...
                <div className="p-6 rounded-2xl glass">
                  ...
                  <div className="space-y-3">
                    <a href="mailto:cooperation@gmail.com" className="block text-white/60 hover:text-[#34C7FF] transition-colors">
                      cooperation@gmail.com
                    </a>
                    <a href="tel:+48579366868" className="block text-white/60 hover:text-[#34C7FF] transition-colors">
                      +48 579 366 868
                    </a>
                  </div>
                </div>
